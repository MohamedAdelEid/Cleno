              ...
              render={({ field, fieldState }) => (
                <Field invalid={!!fieldState.error}>
                  ...
                  <FileUpload
                    ...
                    existingPreviewUrl={existingCommercialRegistrationUrl}
                    existingFilePath={existingCommercialRegistrationPath}
                    onExistingPreviewRemove={onExistingCommercialRegistrationRemove}
